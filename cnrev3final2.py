...
def crossing_number_algorithm1(img, file1, file2):
    ...
    collection, isolate_point, ridge_ending, continuing_ridge, bifurcation_point, crossing_point, valid_bifurcation_point, valid_ridge_ending = crossing_num_calc1(a)
